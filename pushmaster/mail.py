...
from pushmaster import config, logic, model, query
...
class PushMailHandler(InboundMailHandler):
    ...
    def receive(self, mail_message):
        ...
        logging.debug('got mail from %s', original_sender)
        ...
        try:
            ...
            kw = dict(to=requester_emails, subject=mail_message.subject, body=text_body, reply_to=original_sender)
